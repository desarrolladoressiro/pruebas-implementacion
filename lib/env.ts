...
const serverSchema = z.object({
  ...
  SIRO_WEB_URL: z.string().url().optional(),
  SIRO_WEB_USER: z.string().optional(),
  SIRO_WEB_PASSWORD: z.string().optional(),
  SIRO_WEB_USER_HOMOLOGACION: z.string().optional(),
  SIRO_WEB_PASSWORD_HOMOLOGACION: z.string().optional(),
  SIRO_WEB_USER_HOMO: z.string().optional(),
  SIRO_WEB_PASSWORD_HOMO: z.string().optional(),
  SIRO_WEB_USER_PRODUCCION: z.string().optional(),
  SIRO_WEB_PASSWORD_PRODUCCION: z.string().optional(),
  SIRO_WEB_USER_PROD: z.string().optional(),
  SIRO_WEB_PASSWORD_PROD: z.string().optional(),
